...
func _add_collision_hierarchy_up(mesh_instance: MeshInstance3D):
	...
	static_body.name = mesh_instance.name
	
	offset_up.add_child(static_body)
	static_body.owner = offset_up.owner
...
func _add_collision_hierarchy_down(mesh_instance: MeshInstance3D):
	...
	offset_down.add_child(static_body)
	static_body.owner = offset_down.owner
